...
namespace VivaldiCustomLauncher.Tweaks {
    ...
    public class BackgroundCommonBundleScriptTweak: AbstractScriptTweak {
        ...
        protected override Task<string?> editFile(string bundleContents) => Task.Run((Func<string?>) (() => {
            string newBundleContents = exposeFolderSubscriptionStatus(bundleContents);
